...
<aside class="admin-sidebar" id="adminSidebar">
    <nav class="sidebar-nav">
        ...
        <a href="manage_staff.php" class="sidebar-item <?php echo ($current_page ?? '') == 'staff_list' ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"></path>
                <circle cx="9" cy="7" r="4"></circle>
                <path d="M23 21v-2a4 4 0 0 0-3-3.87"></path>
        ...
        <a href="attendance_records.php" class="sidebar-item <?php echo ($current_page ?? '') == 'attendance_records' ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="reports.php" class="sidebar-item <?php echo ($current_page ?? '') == 'reports' ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                <polyline points="14 2 14 8 20 8"></polyline>
                <line x1="16" y1="13" x2="8" y2="13"></line>
        ...
        <a href="settings.php" class="sidebar-item <?php echo ($current_page ?? '') == 'settings' ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
