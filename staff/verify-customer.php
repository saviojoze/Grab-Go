<?php
$page_title = 'Verify Customer - Staff Portal';
    ...
    <div class="admin-container">
        <div class="page-header">
            <div>
                ...
                <p class="text-secondary">Verify customer identity using their 6-digit PIN.</p>
            </div>
        </div>
        ...
        <div class="mt-xl text-center">
            <p class="text-secondary small">
                ...
                The customer can find their PIN on their profile page after logging in.
            </p>
        </div>
    </div>
</main>
