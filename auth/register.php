    ...
    <div class="auth-container">
        ...
        <div class="auth-form-container">
            <div class="auth-form-wrapper">
                ...
                <!-- Google Sign-Up -->
                <button id="googleSignUpBtn" onclick="signUpWithGoogle()" class="btn btn-secondary btn-block btn-lg" style="display: flex; align-items: center; justify-content: center; gap: 12px;">
